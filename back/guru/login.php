		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="login-process.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Harap isikan dengan email atau username yang valid">
					...
					<div class="wrap-input100 validate-input" data-validate="Harap isikan dengan password yang benar">
