<h2 class="border-bottom pb-2" >Materi kelas 10</h2>
        <div class="row justify-content-center mb-3 mt-3">
            <?php
            include '../../config/koneksi.php';
                $query=mysqli_query($koneksi,"SELECT * FROM materi JOIN kelas ON materi.kelas_id = kelas.id_kelas WHERE nama_kelas='10'");
